...
<body>
<form action="./PayManager" method="POST">
...
<div class="container">
    <div class="row">
        <div class="col-12 col-xl-6 mb-3 mx-auto mt-3">
            <div class="card border-0">
                ...
                if($count==0){
                  ...
                  <button class="btn btn-success" onclick="location.href='./AddPay'">前往</button>
                  <?php
                }else{
